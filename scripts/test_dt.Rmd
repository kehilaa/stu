...
ag = SharedData$new(data, key=~paste0(System, Koords), group="stu")
neb = SharedData$new(nebel, key=~paste0(System, Koords), group="stu")
sys = SharedData$new(system, key=~paste0(System, Koords), group="stu")
sd_dt = SharedData$new(system %>% select(System, Koords, Detail), key=~paste0(System, Koords), group="stu")
```
